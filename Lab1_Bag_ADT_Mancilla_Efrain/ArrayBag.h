...
private:
	...
	bool sorted;					// Detects if bag is sorted
...
public:
	...
	int recursive_bin_search(ItemType target, int left_bound, int right_bound); // Recursive binary search
	void display_bag() const;
